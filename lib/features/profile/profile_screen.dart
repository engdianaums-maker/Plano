...
import '../tasks/tasks_screen.dart'; // لتضمين userRoleProvider
...
class ProfileScreen extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return userRoleAsync.when(
      data: (role) {
        final bool isManager = role == 'مدير نظام';
          ...
          body: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                Text(
                  isManager ? (isArabic ? 'مدير النظام (Manager)' : 'Manager') : (isArabic ? 'موظف (Employee)' : 'Employee'),
                  ...
                  child: Column(
                    children: [
                      ...
                      ListTile(
                        ...
                        subtitle: Text(
                          isManager 
                              ? (isArabic ? 'مدير نظام (صلاحيات كاملة الإضافة والتعديل والحذف ومتابعة الموظفين)' : 'Admin Access') 
                              : (isArabic ? 'موظف عادي (عرض وتتبع فقط)' : 'Employee Access'),
